...
And the visitor adds a new user
    ...
    Wait Until Element Is Visible    (//div[contains(@class, 'oxd-select-text-input')])[1]    10s
    Click Element    (//div[contains(@class, 'oxd-select-text-input')])[1]
    Click Element    (//div[@role='listbox']//span)[1]
    
    # Cliquer sur status
    Wait Until Element Is Visible    (//div[contains(@class, 'oxd-select-text-input')])[2]    10s
    Click Element    (//div[contains(@class, 'oxd-select-text-input')])[2]
    Click Element    (//div[@role='listbox']//span)[2]
    
    # Compléter employee nbame
    ...
    # Ajouter le username
    Wait Until Element Is Visible    (//input[contains(@class, 'oxd-input oxd-input--active')])[2]    10s
    Wait Until Element Is Enabled    (//input[contains(@class, 'oxd-input oxd-input--active')])[2]    10s
    ...
    # Ajouter le password
    Wait Until Element Is Visible    //*[@id="app"]/div[1]/div[2]/div[2]/div/div/form/div[2]/div/div[1]/div/div[2]/input    10s
    Wait Until Element Is Enabled    //*[@id="app"]/div[1]/div[2]/div[2]/div/div/form/div[2]/div/div[1]/div/div[2]/input    10s
    ...
    Wait Until Element Is Enabled    //*[@id="app"]/div[1]/div[2]/div[2]/div/div/form/div[2]/div/div[2]/div/div[2]/input    10s
    ...
    # Cliquer sur save
    Wait Until Element Is Visible    //button[contains(@class, 'oxd-button oxd-button--medium oxd-button--secondary orangehrm-left-space')]    10s
    ...
    Wait Until Element Is Visible    //a[@href='/web/index.php/admin/viewAdminModule']    10s
